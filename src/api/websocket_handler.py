...
class WebSocketManager:
    ...
    def handle_message(self, client_id: str, message_data: Dict[str, Any]) -> Dict[str, Any]:
        """
...
class StreamingHandler:
    ...
    def stream_search_results(self, client_id: str, query: str,
    ...
    def stream_monitoring_data(self, channel: str,
                              monitoring_data: Dict[str, Any]) -> int:
        """
