...
class MetricsAggregator:
    ...
    def check_alerts(self, node_id: str, metric_name: str, current_value: float) -> List[Dict]:
        """알림 확인"""
        if node_id in self._alert_managers:
            return self._alert_managers[node_id].check_alert_rules(metric_name, current_value)
        return []
