...
from core.model_loader import load_embedding_model, load_reranker_model, get_available_models
...
from services.optimization.batch_optimizer import get_gpu_memory_info, get_optimal_batch_size, validate_batch_size
...
def create_test_pdf():
    ...
    pdf_canvas.drawString(100, 730, "This is a test document for RAG integration tests.")
    pdf_canvas.drawString(100, 710, "It contains sample text about artificial intelligence.")
    ...
    for i in range(5):
        pdf_canvas.drawString(100, 630 - (i * 20), 
...
class TestRAGInitialization(unittest.TestCase):
    ...
    def test_invalid_config_batch_size(self):
        ...
        invalid_config = self.test_config.copy()
        invalid_config["embedding"]["batch_size"] = 8  # Invalid (allowed: 16,32,64,128,256,512)
    ...
    def test_batch_size_validation(self):
        ...
        is_valid, message = validate_batch_size(batch_size=64, device="cpu", model_type="embedding")
...
class TestDocumentProcessing(unittest.TestCase):
    ...
    def test_batch_embedding(self):
        ...
        with patch(__name__ + ".load_embedding_model", return_value=MagicMock()) as _mock:
...
class TestResponseGeneration(unittest.TestCase):
    ...
    def test_temperature_effect(self):
        ...
        logger.info(f"✓ Valid temperature range verified: 0.0-1.0")
