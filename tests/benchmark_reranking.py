...
async def run_benchmark():
    ...
    docs = [Document(page_content=line, metadata={"page": i+1, "source": "benchmark_doc"}) 
    ...
    for exp in EXPERIMENTS:
        ...
        # Apply patches
        with patch("src.core.rag_core.RETRIEVER_CONFIG", retriever_config_patch), \
            ...
            rag_system.ensemble_retriever.retrievers[1].search_kwargs["k"] = exp["retriever_k"] # FAISS
    ...
    fieldnames = ["experiment_id", "question_id", "retriever_k", "reranker_k", "latency_sec", "answer_length_tokens", "num_docs_used", "reranker_enabled", "error"]
