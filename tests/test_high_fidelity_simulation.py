...
class HighFidelityAppSimulator(unittest.TestCase):
    ...
    def run_streamlit_cycle(self, user_input: str = None):
        ...
        with patch('core.thread_safe_session.st.session_state', self.shared_storage), \
    ...
    def test_high_fidelity_persistence(self):
        ...
        self.assertEqual(len(self.shared_storage.get("messages", [])), 2, "Rerun 후에도 데이터가 유지되어야 함")
