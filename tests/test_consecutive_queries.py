...
async def test_consecutive_queries():
    ...
    assert "CM3" in ans1 or "causally masked" in ans1.lower(), "질문 1에 대한 답변이 부적절합니다."
    ...
    assert any(word in ans2.lower() for word in ["data", "web", "wikipedia", "common", "dataset"]), "질문 2에 대한 답변에 데이터 관련 키워드가 부족합니다."
