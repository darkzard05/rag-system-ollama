...
TOKEN_COUNT = 1000
TOKEN_GENERATION_DELAY = 0.002  # LLM speed: 500 tokens/sec (simulated fast local/slow gpu)
...
async def run_benchmark():
    print(f"🚀 Streaming Optimization Benchmark")
    print(f"Parameters: {TOKEN_COUNT} tokens, LLM Delay={TOKEN_GENERATION_DELAY}s, UI Cost={UI_UPDATE_COST}s")
    print("-" * 60)
